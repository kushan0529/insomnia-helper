                  ...
                  <div className="space-y-3">
                    {group.items.map((item, iIdx) => {
                      ...
                      return (
                        ...
                        >
                          <div className={`w-5 h-5 rounded-md border-1.5 flex flex-col items-center justify-center shrink-0 mt-1 transition-all ${
                            isChecked ? 'bg-green-500/20 border-green-500' : 'border-white/20'
                          }`}>
